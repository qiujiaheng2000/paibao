...
public class ShopActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		shopInfo = (TextView) findViewById(R.id.content);
		address = (TextView) findViewById(R.id.local);
		...
		protected void onPostExecute(NetworkBeanArray result) {
			...
			if(result != null){
				try {
					...
					ImageLoader.getInstance().displayImage(NetworkConfig.baseImgUrl+jsonObject.getString("photo"), cover_user_photo);
