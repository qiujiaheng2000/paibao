...
public class ModifySuccessActivity extends Activity implements
	...
	public void onClick(View v) {
		...
		case R.id.title_bar_right:
			intent.setClass(ModifySuccessActivity.this, FrameActivity.class);
...
//				this.getString(R.string.app_name));
	...
	//	oks.setComment("comment");
		...
		// 显示
		oks.show(ModifySuccessActivity.this);
	}
	...
	public boolean handleMessage(Message msg) {
		...
		Toast.makeText(ModifySuccessActivity.this, text, Toast.LENGTH_SHORT).show();
		return false;
	}
